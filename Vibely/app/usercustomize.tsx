...
const CustomAlert = ({ 
  ...
  const getColors = () => {
    switch(type) {
      case 'success': return { bg: '#FF5722', icon: 'checkcircle' };
...
const UserCustomize = () => {
  ...
  useEffect(() => {
    ...
    const hasSelectedCategory = categories.some(category => category.selected);
...
const handleContinue = () => {
    if (isFormValid) {
      ...
      const userData = {
        ...
        preferences: categories.filter(cat => cat.selected).map(cat => cat.name)
      };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.ScrollView}>
          ...
          >
            <Text style={styles.preferencesTitle}>What are your preferred events? <Text style={styles.required}>*</Text></Text>
